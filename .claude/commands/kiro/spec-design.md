...
- Verify `docs/specs/$1/requirements.md` exists
...
- docs/steering/*.md
- docs/settings/rules/design-*.md
- docs/settings/templates/specs/design.md
- docs/settings/templates/specs/research.md
