...
- docs/settings/templates/steering-custom/*.md
...
Available templates in `docs/settings/templates/steering-custom/`:
...
- `docs/settings/` content should NOT be documented (it's metadata, not project knowledge)
